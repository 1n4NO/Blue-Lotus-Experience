        ...
        return (
          <div key={item.question}>
            <button
              ...
              className="flex w-full items-center justify-between gap-5 py-[1.125rem] text-left transition duration-500 ease-calm sm:py-5"
            >
            ...
            <AnimatePresence initial={false}>
              {isOpen ? (
                <motion.div
                  ...
                  className="overflow-hidden pb-5 sm:pb-6"
                >
